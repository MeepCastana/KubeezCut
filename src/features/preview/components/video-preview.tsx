...
export const VideoPreview = memo(function VideoPreview({
  ...
  return (
    <div
      ref={backgroundRef}
      className="w-full h-full panel-bg relative"
    ...
    >
      <div
        className="flex min-h-full w-full flex-col items-center justify-end"
        style={{
          paddingLeft: `calc(${EDITOR_LAYOUT_CSS_VALUES.previewPadding} / 2)`,
          paddingRight: `calc(${EDITOR_LAYOUT_CSS_VALUES.previewPadding} / 2)`,
          paddingBottom: 6,
        }}
        onClick={handleBackgroundClick}
      >
